    ...
    return (
        <>
            <div className="introAbout">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; MMU believes in the principles of Honesty, Integrity and Transparency. The Institute aims to provide a harmonic environment to all the students, employees, associates and stakeholders. To facilitate these, MMU Internal Complaints Committee(ICC) brought up an idea to built a Student Grievance Redressal Portal. Various Departments like Academics &#38; Examination Department, Accounts &#38; Fees Department, Administration Department, Anti-Ragging &#38; Harassment Department, Infrastructure Department are made and faculties are assignment for goodwill of students. Any student who finds any discrepancy can use this portal to register a complaint and respective department will take further actions to resolve the problem.
                <br/>
                <br/>
                ...
                <ul style={{marginLeft:'2%'}}>
                    <li>
                        ...
                        <ul style={{marginLeft:'4%'}}>
                            ...
                            <li>Prof John Doe : +254685908780</li>
                        </ul>
                    </li>
                </ul>
                <ul style={{marginLeft:'2%'}}>
                    <li>
                        ...
                        <ul style={{marginLeft:'4%'}}>
                            ...
                            <li>Prof Mark Eddy : +254790908733</li>
                        </ul>
                    </li>
                </ul>
                <ul style={{marginLeft:'2%'}}>
                    <li>
                        ...
                        <ul style={{marginLeft:'4%'}}>
                            ...
                            <li>Prof Reece James : +254631456907</li>
                        </ul>
                    </li>
                </ul>
                <ul style={{marginLeft:'2%'}}>
                    <li>
                        ...
                        <ul style={{marginLeft:'4%'}}>
                            ...
                            <li>Prof Michael Scofield : +254898453454</li>
                        </ul>
                    </li>
                </ul>
                <ul style={{marginLeft:'2%'}}>
                    <li>
                        ...
                        <ul style={{marginLeft:'4%'}}>
                            ...
                            <li>Prof Kevin Bradley : +254976895645</li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div className="last">
                &copy; Copyrights Reserved 2023 | Nicholas Mumo 
            </div>
        </>
    )
}
